    ...
    const conversation = [
      ...
      { sender: "bot", text: "I am most comfortable with Python but I also heavily used Java, Javascript, Typescript and C++ as well. I worked in areas such as Data Science (PyTorch, pandas, numpy, notebooks), Backend/AI-Engineer(FastAPI, AWS, pydantic, pydantic-ai, haystack, langchain) and Frontend (React, Next.js, Vue, Dash). Some of the work included extending standalone semantic search systems, building/maintaining RAG Systems, building data pipelines, improving accessibility and design, building data analytics dashboard to track usage KPIs, API Development (REST and Graphql) and much more. " },
      { sender: "user", text: "What experience do you have?" },
      { sender: "bot", text: "I worked at Mitsubishi Electric, where I mainly did work on maintenance of the products database (MariaDB), as well as updates to the website of their webshop. Then I switched to CQSE, who develop and maintain a software quality analysis tool called Teamscale. There I mainly did frontend work in Typescript and React to improve accesibilty and design of the Test Coverage View of the tool as well as extensive testing with JUnit and Playwright. I started working at Foxbase in octobre 2024 as a full time intern for 3 months, and am working as a working student since february.  There my work included: Extending/maintaning the AI/Data side of the Product such as the RAG System, various data pipelines for proecessing/transforming data to and from our system for our clients, extending and improving the data analytics side of the product such as creating more efficient database tables to fetch aggregated data (e.g. daily user statistics) and polishimg the Dash dashboard used to present the data to our clients with nice graphs." },
      { sender: "user", text:"What do you like to do in your free time?"},
      { sender: "bot", text: "I actively train BJJ multiple times a week and also compete in tournaments a couple of times a year. I also like to code projects that don’t exist yet but I want to use myself. I love Japanese culture, so I’ve been learning the language for 2 years (currently A2). In the evenings, I mostly read Russian, German, and French novels from before 1950 or watch some anime." },
